---
title: "PASTA_Figure2_Quantification"
...
annotation <- read_csv("data/Fig2/04_final_data/Fig2_final_annotation.csv") %>%
  select(-clustering_id)

df_normRawFeatures <- read_csv("data/Fig2/04_final_data/Fig2_NormFeaturesCellData.csv")

df_normPercentileFeatures <- read_csv("data/Fig2/04_final_data/Fig2_NormPercentileFeaturesCellData.csv")

df_finalFeatures <- read_csv("data/Fig2/04_final_data/Fig2_FinalFeaturesCellData.csv")
...
ggsave("output/Fig2/Fig2C.pdf", create.dir = TRUE, width = 5, height = 5, units = "in", dpi = 300)
```

```{r}
# --- Stats: Fig 2C ---
cat("Fig 2C - Correlation test (overall A4 vs A3):\n")
cor_test_2c <- cor.test(plot_df$A4, plot_df$A3, use = "complete.obs", method = "pearson")
cat("r  =", round(cor_test_2c$estimate, 6), "\n")
cat("r2 =", round(cor_test_2c$estimate^2, 6), "\n")
cat("p  =", cor_test_2c$p.value, "\n")
```
...
fig2d <- ggplot(df_2D, aes(x = marker, y = median_expression, fill = disease)) +
...
ggsave("output/Fig2/Fig2D.pdf", width = 10, height = 5, units = "in", dpi = 300)
```
...
fig2E <- ggplot(df_2E, aes(x = interaction(annotation, marker, sep = "|"), y = median_expression, fill = disease)) +
  geom_violin(scale = "width",
              width = 0.5,
              trim = TRUE,
              draw_quantiles = 0.5,
...
ggsave("output/Fig2/Fig2E.pdf", width = 10, height = 5.5, units = "in", dpi = 300)
```
...
ggplot(df_2F_CD57, aes(x = interaction(marker, annotation, sep = "|"), y = median_expression, fill = disease)) +
  geom_violin(scale = "width",
              width = 0.5,
              trim = TRUE,
              draw_quantiles = 0.5,
...
ggsave("output/Fig2/Fig2F_CD57.pdf", width = 10, height = 5.5, units = "in", dpi = 300)
...
ggplot(df_2F_ICOS, aes(x = interaction(marker, annotation, sep = "|"), y = median_expression, fill = disease)) +
  geom_violin(scale = "width",
              width = 0.5,
              trim = TRUE,
              draw_quantiles = 0.5,
...
ggsave("output/Fig2/Fig2F_ICOS.pdf", width = 10, height = 5.5, units = "in", dpi = 300)
```
...
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_CODEX_Hodgkin.pdf", create.dir = TRUE, plot = p_A3_HD, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_PASTA_Hodgkin.pdf", plot = p_A4_HD, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_CODEX_DLBCL.pdf", plot = p_A3_DLBCL, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_PASTA_DLBCL.pdf", plot = p_A4_DLBCL, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_CODEX_LNT.pdf", plot = p_A3_Healthy, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_PASTA_LNT.pdf", plot = p_A4_Healthy, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig6B_heatmap_legend.pdf", plot = p_legend, device = cairo_pdf,
       width = 2.5, height = 2.5, units = "in")
...
```
```{r}
# --- N: Extended Data Fig 6B ---
# Heatmap: N = total cells per panel

cat("Extended Data Fig 6B - N total cells per panel:\n")
df_combined %>%
  dplyr::group_by(TMA, disease) %>%
  dplyr::summarise(N = n(), .groups = "drop") %>%
  dplyr::arrange(disease, TMA) %>%
  print()
```
...
ggsave("output/ExtendedDataForFig2/ExtendedDataFig8A.pdf", width = 4.5, height = 2.25, units = "in", dpi = 300)
```
...
ggsave("output/ExtendedDataForFig2/ExtendedDataFig8B.pdf", width = 9, height = 10, units = "in", dpi = 300)
...
ggsave("output/ExtendedDataForFig2/ExtendedDataFig9_1.pdf", plot = p1, device = cairo_pdf,
       width = 8, height = 4.7, units = "in")
ggsave("output/ExtendedDataForFig2/ExtendedDataFig9_2.pdf", plot = p2, device = cairo_pdf,
       width = 8, height = 4.7, units = "in")
...
ggsave("output/ExtendedDataForFig2/ExtendedDataFig10A.pdf", width = 8.5, height = 5, units = "in", dpi = 300)
```
